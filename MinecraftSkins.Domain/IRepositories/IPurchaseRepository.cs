...
{
    Task<ICollection<Purchase>> GetAllAsync(string? buyerId, string? buyerUserName, Guid? skinId, DateTime? from, DateTime? to, int skip, int take, CancellationToken cancellationToken = default);
